...
<body>
    <div class="main-wrapper">
        ...
        <div class="banner-area pt-100 pb-100">
            <div class="container">
                <div class="bg-img pt-100 pb-100 learn-banner" style="background-image:url(assets/images/bg/banner-bg-1.jpg);">
                    <div class="row">
        ...
        <div class="product-area pb-135">
            <div class="container">
                ...
                <div class="product-slider-active owl-carousel">
                    ...
                    <div class="product-wrap">
                        <div class="product-img mb-15">
                            <a href="product-details.html"><img src="assets/images/product/pro-hm1-3.jpg" alt="product"></a>
...
<form action=".php" method="POST">
 <input type="hidden" name="f_id" value="<?php echo $row['F_ProductID'] ?>">
     </form>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="product-wrap mb-35">
                            <div class="product-img mb-15">
                                <a href="product-details.html"><img src=admin/<?php echo $row['F_Product_Photo'];?> alt="product"></a>
            ...
            if(mysqli_num_rows($query_run2) > 0)        
            {
                while($row = mysqli_fetch_assoc($query_run2))
                {
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="product-wrap mb-35">
                            <div class="product-img mb-15">
                                <a href="product-details.html"><img src=admin/<?php echo $row['B_Product_Photo'];?> alt="product"></a>
            ...
            if(mysqli_num_rows($query_run3) > 0)        
            {
                while($row = mysqli_fetch_assoc($query_run3))
                {
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="product-wrap mb-35">
                            <div class="product-img mb-15">
                                <a href="product-details.html"><img src=admin/<?php echo $row['G_Product_Photo'];?> alt="product"></a>
