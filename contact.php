                        ...
                        <div class="col-xl-3 col-lg-3">
                            <div class="header-right-wrap mt-10">
                                <div class="header-wishlist">
                                    <a href="cart.html"><i class="la la-shopping-cart"></i></a>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-contact-info extra-contact-info text-center mb-30">
                                <ul>
                                    <li><i class="ti-mobile"></i> 111-222-999 </li>
                                    <li><i class="ti-email"></i> <a href="#"> dummy@example.com</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                    ...
                    <div class="contact-from contact-shadow">
                        <form id="contact-form" action="Code.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <button class="submit" type="submit" name='message_btn'>Send Message</button>
                                </div>
                            </div>
                        </form>
